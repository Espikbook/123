    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                ...
                $(button).html('<i class="bi bi-check-circle-fill"></i> Seguido')
            } else {
                $(button).attr('disabled', false);

                alert('Algo ocurrió mal, inténtalo nuevamente después.');
            }
        }
    });
});
...
$(".unfollowbtn").click(function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.status) {
                $(button).data('userId', 0);
                $(button).html('<i class="bi bi-check-circle-fill"></i> No seguido')
            } else {
                $(button).attr('disabled', false);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.status) {
                ...
                $("#sra").html('<p class="text-center text-muted">No se encontró el usuario.</p>');
