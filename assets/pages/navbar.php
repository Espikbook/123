        ...
        <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
            <div class="d-flex justify-content-between col-lg-8 col-sm-12">
                <a class="navbar-brand" href="?">
                    <img src="assets/images/logo1.png" alt="" height="28">

                </a>

                <form class="d-flex" id="searchform">
                    <input class="form-control me-2" type="search" id="search" placeholder="Buscar gente..."
...
<p class="text-center text-muted">Ingresa el nombre o nombre de usuario</p>
            ...
            <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-1 mb-sm-0">
                ...
                <li class="nav-item">
        <a class="nav-link text-dark" href="assets/pages/select_room.php?user_id=<?= $user['id'] ?>">
  ...
  <a class="nav-link text-dark" data-bs-toggle="offcanvas" href="#notification_sidebar" role="button" aria-controls="offcanvasExample"><i class="bi bi-bell-fill"></i></a>
    <?php
                ...
                <li class="nav-item dropdown dropstart">
                    ...
                    <li><a class="dropdown-item" href="?u=<?=$user['username']?>"><i class="bi bi-person"></i> Mi perfil</a></li>
                        ...
                        <li><a class="dropdown-item" href="assets/php/actions.php?logout"><i class="bi bi-box-arrow-in-left"></i> Cerrar sesión</a></li>
                    </ul>
                </li>
