...
if($action=='verifycode'){
    ?>
<p>Ingresa el código de 6 dígitos que te enviamos. (<?=$_SESSION['forgot_email']?>)</p>
...
if($action=='changepassword'){
    ?>
<p>Ingresa tu nueva contraseña. (<?=$_SESSION['forgot_email']?>)</p>
<div class="form-floating mt-1">
...
?>
                ...
                <a href="?login" class="text-decoration-none mt-5"><i class="bi bi-arrow-left-circle-fill"></i> Volver a Iniciar Sesión</a>
            </form>
        </div>
    </div>
