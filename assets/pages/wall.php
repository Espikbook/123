 ...
 ?>
    <div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        <div class="col-md-8 col-sm-12" style="max-width:93vw">
            ...
            showError('post_img');
            if(count($posts)<1){
                echo "<p style='width:93vw' class='p-2 bg-white border rounded text-center my-3 col-12'>Sigue a alguien o publica algo.</p>";
            }
...
$unlike_btn_display='';
    ...
    ?>
                ...
                &nbsp;&nbsp;<i
                        class="bi bi-chat-left d-flex align-items-center"><span class="p-1 mx-2 text-small" style="font-size:small" data-bs-toggle="modal" data-bs-target="#postview<?=$post['id']?>"><?=count($comments)?> comentarios</span></i> 
                        
                </h4>
                <div>
                <span class="p-1 mx-2" data-bs-toggle="modal" data-bs-target="#likes<?=$post['id']?>"><span id="likecount<?=$post['id']?>"><?=count($likes)?></span> me gusta</span>
                <span style="font-size:small" class="text-muted">Publicado</span> <?=show_time($post['created_at'])?> 
...
if($post['post_text']){
 ...
 <div class="card-body">
  ...
  ?> 
                ...
                <div style="font-size:small" class="text-muted">Publicado <?=show_time($post['created_at'])?> </div> 
...
if(count($comments)<1){
    ?>
<p class="p-3 text-center my-2 nce">No existen comentarios.</p>
    <?php
}
...
<div class="d-flex align-items-center p-2">
  ...
  <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Me gusta</h5>
...
<div class="d-flex justify-content-between">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div>
                <h6 class="text-muted p-2">Sugerencias para seguir...</h6>
                <?php
...
if(count($follow_suggestions)<1){
    echo "<p class='p-2 bg-white border rounded text-center'>No hay sugerencias para ti.</p>";
}
                ?>
