...
function sendCode($email,$subject,$code){
    ...
    try {
        ...
        $mail->Username   = 'espikbook@gmail.com';                     //SMTP username
        $mail->Password   = 'snsd rrde fgvg upxv';                               //SMTP password snsd rrde fgvg upxv
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    
        //Recipients
        $mail->setFrom('espikbook@gmail.com', 'Espikbook');     //Add a recipient
